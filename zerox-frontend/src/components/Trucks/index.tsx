...
const items = [
    ...
    { title: 'ZEROX002-TN', description: 'Volvo FH16', icon: TruckIcon, background: 'bg-red-500', batStatus: Battery0Icon },
    ...
    { title: 'ZEROX005-TN', description: 'Renault T-series', icon: TruckIcon, background: 'bg-red-500', batStatus: Battery0Icon },
    ...
    { title: 'ZEROX008-TN', description: 'Freightliner Cascadia', icon: TruckIcon, background: 'bg-red-500', batStatus: Battery0Icon },
    ...
    { title: 'ZEROX011-TN', description: 'Western Star 5700', icon: TruckIcon, background: 'bg-red-500', batStatus: Battery0Icon },
    ...
    { title: 'ZEROX014-TN', description: 'Volvo VNL', icon: TruckIcon, background: 'bg-red-500', batStatus: Battery0Icon },
    ...
    { title: 'ZEROX017-TN', description: 'Peterbilt 389', icon: TruckIcon, background: 'bg-red-500', batStatus: Battery0Icon },
    ...
    { title: 'ZEROX020-TN', description: 'International ProStar', icon: TruckIcon, background: 'bg-red-500', batStatus: Battery0Icon },
    ...
    { title: 'ZEROX023-TN', description: 'Scania P-series', icon: TruckIcon, background: 'bg-red-500', batStatus: Battery0Icon },
    ...
    { title: 'ZEROX026-TN', description: 'DAF CF', icon: TruckIcon, background: 'bg-red-500', batStatus: Battery0Icon },
    ...
    { title: 'ZEROX029-TN', description: 'Kenworth T800', icon: TruckIcon, background: 'bg-red-500', batStatus: Battery0Icon },
    ...
    { title: 'ZEROX032-TN', description: 'Mack Granite', icon: TruckIcon, background: 'bg-red-500', batStatus: Battery0Icon },
    ...
    { title: 'ZEROX035-TN', description: 'Freightliner 122SD', icon: TruckIcon, background: 'bg-red-500', batStatus: Battery0Icon },
    ...
    { title: 'ZEROX038-TN', description: 'Western Star 6900', icon: TruckIcon, background: 'bg-red-500', batStatus: Battery0Icon },
    ...
    { title: 'ZEROX041-TN', description: 'Mercedes Econic', icon: TruckIcon, background: 'bg-red-500', batStatus: Battery0Icon },
    ...
    { title: 'ZEROX044-TN', description: 'MAN TGL', icon: TruckIcon, background: 'bg-red-500', batStatus: Battery0Icon },
    ...
    { title: 'ZEROX047-TN', description: 'Iveco Eurocargo', icon: TruckIcon, background: 'bg-red-500', batStatus: Battery0Icon },
